...
if __name__ == '__main__':
    ...
    # options = {"initialization": "smoothing", "polyatomic": False, "swarm": False, "sliding": True, "positive_constraint": False,
    ...
    options = {"initialization": "grid", "polyatomic": True, "swarm": False, "sliding": False, "positive_constraint": False,
               "max_iter": 5, "dual_certificate_tol": 1e-2, "smooth_sigma": 20, "animation": False}
    solver = FW(y, forward_op, lambda_, x_dim, bounds=bounds, verbose=False, show_progress=False, options=options)
    t1 = time()
    solver.fit()
    print("Time: ", time() - t1)
